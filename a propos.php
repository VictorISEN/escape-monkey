...
<head>
    ...
    <title>About us| Escape Monkey</title>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <section class="container my-5">
        <div class="row">
            <div class="col-lg-10" style="height: 350px;">
                <h1 class="display-4">About Escape Monkey</h1>
                <p class="lead">Escape Monkey is an exciting 2D maze game where you have to help a monkey escape from a complicated maze. Developed by a team of dedicated computer engineering students, our goal is to provide a fun and challenging gaming experience.</p>
                <hr class="my-4">
                <p>The game is constantly evolving, with new features and levels added regularly. Stay tuned for updates and have fun playing Escape Monkey!</p>
            </div>
        </div>
    </section>
...
<footer class="footer bg-warning text-center text-white">
    <div class="container p-2"> <!-- Réduction du padding à 2 -->
        <section class="mb-2"> <!-- Réduction de la marge à 2 -->
            <!-- Social media icons -->
        ...
        <section class="mb-2"> <!-- Réduction de la marge à 2 -->
            <div class="col-lg-4 col-md-6 mb-2 mb-md-0"> <!-- Réduction de la marge à 2 -->
        ...
        <hr class="my-2"> <!-- Réduction de la marge à 2 -->
        <!-- Copyright text -->
        <div class="text-center p-1" style="background-color: rgba(0, 0, 0, 0.2);">
            © 2023 All rights reserved. Designed by TeamSinj.
        </div>
    </div>
</footer>
