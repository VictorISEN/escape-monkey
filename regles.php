...
<head>
    ...
    <title>Rules | Escape Monkey</title>
</head>
<body>
    <!-- Navigation Bar -->
    ...
    <section class="container my-5">
        <div class="row">
            <div class="col-lg-12" style="height: 300px;">
                ...
                <p class="lead">Here's how to play Escape Monkey</p>
                <hr class="my-4">
                <ol>
                    <li><strong>Objective :</strong> The object of the game is to help the monkey escape from the maze.</li>
                    <li><strong>Controls :</strong> Use the arrow keys to move the monkey through the maze.</li>
                    <li><strong>Scoring :</strong> You earn points by completing the maze quickly. The faster you finish, the more points you score.</li>
                    <!-- Ajoutez plus de règles si nécessaire -->
                </ol>
            </div>
        </div>
    </section>
